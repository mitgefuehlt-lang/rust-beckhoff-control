...
impl MachineNewTrait for SchneideMaschineV1 {
    fn new<'maindevice>(params: &MachineNewParams) -> Result<Self, Error> {
        info!("[SchneideMaschineV1::new] Starting initialization...");
        ...
        let hardware = match &params.hardware {
            ...
            _ => {
                let err = anyhow::anyhow!(
                    "[{}::MachineNewTrait/SchneideMaschineV1::new] MachineNewHardware is not Ethercat",
                    module_path!()
                );
                tracing::error!("{}", err);
                return Err(err);
        ...
        block_on(async {
            info!("[SchneideMaschineV1::new] Acquiring EL1008 (Role 0)...");
            let el1008_res =
            ...
            let el1008 = match el1008_res {
                Ok(dev) => {
                    info!("[SchneideMaschineV1::new] Successfully acquired EL1008");
                    dev.0
                }
                Err(e) => {
                    tracing::error!(
            ...
            info!("[SchneideMaschineV1::new] Acquiring EL2008 (Role 1)...");
            ...
            let el2008 = match el2008_res {
                Ok(dev) => {
                    info!("[SchneideMaschineV1::new] Successfully acquired EL2008");
                    dev.0
                }
                Err(e) => {
                    tracing::error!(
            ...
            info!("[SchneideMaschineV1::new] Acquiring EL2522 (Role 2)...");
            let el2522_res =
            ...
            let mut machine = Self {
                ...
                namespace: SchneideMaschineV1Namespace {
